 ...
 * @author dob
 */
class HandlerProductEditor extends CrmHandlerBase {

    /**
     * @var OfferPropertyObj
     */
    protected $mainObj;
    ...
    function __construct() {
        ...
        $this->mainObj = new OfferPropertyObj($_REQUEST['property_id']);
    ...
    public function read_item() {
        return array(
            'success' => true,
            'data' => $this->mainObj->cGetValues()
        );
    }

    public function read() {
        // initialize variables
        $where = 'property_offer = %i';
...
//        die($query);
        $arr = DB::query($query, $_REQUEST['property_offer']);
