 ...
 * @author dob
 */
class HandlerQueueKoef extends CrmHandlerBase {
    ...
    function __construct() {
        ...
        $this->mainObj = new PredictiveMultiplierObj($_REQUEST['id']);
...
//        die($query);
    ...
    public function update($attributes) {
        $this->mainObj->cSetLoggingState(false);
        $ret = parent::update($attributes);
        bari_base();
        $this->mainObj->cSetLoggingState(true);
        $this->mainObj->cSaveChangeLog('update');
